...
import { formatCurrency, formatNumber, formatPercentage, calculateROI, calculateProfit } from '../utils/formatters'
...
const ProjectDetail = () => {
  ...
  const totalInvestment = project.purchase_price + project.transfer_fees + project.renovation_cost
  const totalProfit = calculateProfit(totalInvestment, project.selling_price)
  const roi = calculateROI(totalInvestment, project.selling_price)
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <div className="relative">
              <img 
                src={project.image_url || `https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=400&fit=crop`} 
                alt={project.title}
              ...
              <div className="absolute top-4 left-4 space-y-2">
                ...
                <span className={`block px-3 py-1 rounded-full text-sm font-semibold ${getStatusBadgeClasses(project.status)}`}>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="font-semibold">{formatNumber(project.size)}</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="p-4 bg-blue-50 rounded-lg">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-semibold text-lg">{formatCurrency(project.price)}</span>
                      </div>
                    </div>
                    {project.roi && (
                      <div className="p-4 bg-green-50 rounded-lg">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-semibold text-lg text-green-600">{formatPercentage(project.roi)}</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {project.golden_visa && (
                    <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      <h4 className="font-semibold text-yellow-800 mb-2">Golden Visa Benefits</h4>
                      <ul className="text-sm text-yellow-700 space-y-1">
                        <li>• Minimum investment: €250,000</li>
                        <li>• 5-year renewable residency permit</li>
                        <li>• Family members included (spouse, children under 21)</li>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between py-2 border-b">
                        ...
                        <span>{formatCurrency(project.purchase_price || 0)}</span>
                      </div>
                      <div className="flex justify-between py-2 border-b">
                        <span>Transfer Fees</span>
                        <span>{formatCurrency(project.transfer_fees || 0)}</span>
                      </div>
                      <div className="flex justify-between py-2 border-b">
                        <span>Renovation Cost</span>
                        <span>{formatCurrency(project.renovation_cost || 0)}</span>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between py-2 border-b">
                        ...
                        <span>{formatCurrency(project.selling_price || 0)}</span>
                      </div>
                      <div className="flex justify-between py-2 border-b">
                        <span>Total Investment</span>
                        <span>{formatCurrency(totalInvestment)}</span>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <Check className="h-4 w-4 text-green-600" />
                        <span>{formatNumber(project.size)} m² Living Space</span>
                      </div>
                    </div>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {project.roi && (
                <div className="flex justify-between">
                  <span className="text-gray-600">Expected ROI</span>
                  <span className="font-semibold text-green-600">{formatPercentage(project.roi)}</span>
                </div>
              )}
              <div className="flex justify-between">
